...
Plugin for NOMAD Oasis at PeroLab Marburg
...
```sh
git clone https://github.com/AG-SEK/nomad-perolab-umr.git
cd nomad-perolab-umr
...
```sh
pip install dist/nomad-perolab-umr-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Aaron Schüller-Ruhl | [aaron.schueller-ruhl@physik.uni-marburg.de](mailto:aaron.schueller-ruhl@physik.uni-marburg.de)
